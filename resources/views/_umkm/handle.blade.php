...
@section('title_page')
    <h2>Daftar Pesanan
        <small>Pesanan yang telah diproses</small>
    </h2>
@endsection
@section('content')
                        ...
                        <div class="media">
                            <div class="media-body">
                                ...
                                <div class="float-right">
                                    ...
                                    <a href="{{route('umkm.order.print',['id' => encrypt($item->id)])}}" target="_blank">
                                        <button class="btn btn-warning btn-icon  btn-icon-mini btn-round"
                                                data-toggle="tooltip"
                                                title="Print tagihan">
