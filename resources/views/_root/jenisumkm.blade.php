...
@section('title','Data Jenis Umkm')
@section('title_page')
    <h2>Jenis Umkm
        <small>Data Jenis Umkm</small>
    </h2>
@endsection
@section('content')
    <div class="row clearfix">
        <div class="col-xl-5 col-lg-5 col-md-12">
            <div role="tabpanel" class="tab-pane">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="post" action="{{route('root.jenis.umkm.store')}}">
                            {{csrf_field()}}
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Nama Jenis Umkm" name="name_"
        ...
        <div class="col-xl-7 col-lg-5 col-md-12">
            <div role="tabpanel" class="tab-pane">
                <div class="card">
                    <div class="header">
                        <h2><strong>Data</strong> Jenis Umkm</h2>
                    </div>
                    <div class="body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-form-{{$datas->id}}"
                                                  action="{{ route('root.jenis.umkm.delete',['id' => $datas->id])}}" method="POST"
                                                  style="display: none;">
    ...
    <div class="modal fade" id="largeModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form action="{{route('root.jenis.umkm.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group form-float" id="divlasan">
                            <label for="jenis_umkm">Nama Jenis Umkm</label>
                            <input type="text" id="jenis_umkm" class="form-control" name="jenis_umkm">
                        </div>
